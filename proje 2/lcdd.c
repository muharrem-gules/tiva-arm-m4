...
void baslangic(void)   //LCD baþlangýç ayarlarýný yapar.
{
    ...
    LCD_sil();
        ...
        komut_yaz(0x06);//kursörü saða kaydýr
        komut_yaz(0x80);//kursör konumu
        komut_yaz(0x0f);//kursörü aç
        LCD_sil();
}
//===========================================================================
...
{
    int a;
    a=GPIOIntStatus(GPIO_PORTF_BASE,true);  // hangi pinden kesme geldiðini gösteriyor
